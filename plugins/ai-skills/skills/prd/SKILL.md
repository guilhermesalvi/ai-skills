...
| [Requisitos e seções](references/writing.md) | Ao criar um PRD; ao editar, nas regras que a mudança toca | Origem dos fatos, premissas e lacunas, comportamento observável, capabilities e eventos, forma dos requisitos, diagramas e seções |
